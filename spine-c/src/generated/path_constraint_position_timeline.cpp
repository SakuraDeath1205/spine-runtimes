...
void spine_path_constraint_position_timeline_apply(spine_path_constraint_position_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    PathConstraintPositionTimeline *_self = (PathConstraintPositionTimeline *) self;
...
float spine_path_constraint_position_timeline_get_relative_value(spine_path_constraint_position_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    PathConstraintPositionTimeline *_self = (PathConstraintPositionTimeline *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_path_constraint_position_timeline_get_absolute_value_1(spine_path_constraint_position_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    PathConstraintPositionTimeline *_self = (PathConstraintPositionTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_path_constraint_position_timeline_get_absolute_value_2(spine_path_constraint_position_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    PathConstraintPositionTimeline *_self = (PathConstraintPositionTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_path_constraint_position_timeline_get_scale_value(spine_path_constraint_position_timeline self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    PathConstraintPositionTimeline *_self = (PathConstraintPositionTimeline *) self;
