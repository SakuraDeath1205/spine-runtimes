...
void spine_physics_constraint_timeline_apply(spine_physics_constraint_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    PhysicsConstraintTimeline *_self = (PhysicsConstraintTimeline *) self;
...
float spine_physics_constraint_timeline_get_relative_value(spine_physics_constraint_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    PhysicsConstraintTimeline *_self = (PhysicsConstraintTimeline *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_physics_constraint_timeline_get_absolute_value_1(spine_physics_constraint_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    PhysicsConstraintTimeline *_self = (PhysicsConstraintTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_physics_constraint_timeline_get_absolute_value_2(spine_physics_constraint_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    PhysicsConstraintTimeline *_self = (PhysicsConstraintTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_physics_constraint_timeline_get_scale_value(spine_physics_constraint_timeline self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    PhysicsConstraintTimeline *_self = (PhysicsConstraintTimeline *) self;
