...
void spine_scale_y_timeline_apply(spine_scale_y_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    ScaleYTimeline *_self = (ScaleYTimeline *) self;
...
float spine_scale_y_timeline_get_relative_value(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    ScaleYTimeline *_self = (ScaleYTimeline *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_scale_y_timeline_get_absolute_value_1(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    ScaleYTimeline *_self = (ScaleYTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_scale_y_timeline_get_absolute_value_2(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    ScaleYTimeline *_self = (ScaleYTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_scale_y_timeline_get_scale_value(spine_scale_y_timeline self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    ScaleYTimeline *_self = (ScaleYTimeline *) self;
...
void spine_scale_y_timeline_set_bezier(spine_scale_y_timeline self, size_t bezier, size_t frame, float value, float time1, float value1, float cx1, float cy1, float cx2, float cy2, float time2, float value2) {
    ScaleYTimeline *_self = (ScaleYTimeline *) self;
