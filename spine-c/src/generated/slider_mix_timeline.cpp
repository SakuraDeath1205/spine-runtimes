...
void spine_slider_mix_timeline_apply(spine_slider_mix_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    SliderMixTimeline *_self = (SliderMixTimeline *) self;
...
float spine_slider_mix_timeline_get_relative_value(spine_slider_mix_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    SliderMixTimeline *_self = (SliderMixTimeline *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_slider_mix_timeline_get_absolute_value_1(spine_slider_mix_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    SliderMixTimeline *_self = (SliderMixTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_slider_mix_timeline_get_absolute_value_2(spine_slider_mix_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    SliderMixTimeline *_self = (SliderMixTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_slider_mix_timeline_get_scale_value(spine_slider_mix_timeline self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    SliderMixTimeline *_self = (SliderMixTimeline *) self;
