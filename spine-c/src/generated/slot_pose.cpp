...
float spine_slot_pose_get_bleach(spine_slot_pose self) {
    SlotPose *_self = (SlotPose *) self;
	return _self->getBleach();
}

void spine_slot_pose_set_bleach(spine_slot_pose self, float bleach) {
    SlotPose *_self = (SlotPose *) self;
	_self->setBleach(bleach);
}
