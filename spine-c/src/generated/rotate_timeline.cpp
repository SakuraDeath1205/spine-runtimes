...
void spine_rotate_timeline_apply(spine_rotate_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    RotateTimeline *_self = (RotateTimeline *) self;
...
float spine_rotate_timeline_get_relative_value(spine_rotate_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    RotateTimeline *_self = (RotateTimeline *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_rotate_timeline_get_absolute_value_1(spine_rotate_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    RotateTimeline *_self = (RotateTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_rotate_timeline_get_absolute_value_2(spine_rotate_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    RotateTimeline *_self = (RotateTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_rotate_timeline_get_scale_value(spine_rotate_timeline self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    RotateTimeline *_self = (RotateTimeline *) self;
