...
SPINE_C_API /*@null*/ float * spine_render_command_get_bleaches(spine_render_command self);
SPINE_C_API int32_t spine_render_command_get_slot_index(spine_render_command self);
SPINE_C_API /*@null*/ const char * spine_render_command_get_slot_name(spine_render_command self);
