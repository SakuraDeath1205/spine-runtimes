...
float spine_constraint_timeline1_get_relative_value(spine_constraint_timeline1 self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    ConstraintTimeline1 *_self = (ConstraintTimeline1 *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_constraint_timeline1_get_absolute_value_1(spine_constraint_timeline1 self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    ConstraintTimeline1 *_self = (ConstraintTimeline1 *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_constraint_timeline1_get_absolute_value_2(spine_constraint_timeline1 self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    ConstraintTimeline1 *_self = (ConstraintTimeline1 *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_constraint_timeline1_get_scale_value(spine_constraint_timeline1 self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    ConstraintTimeline1 *_self = (ConstraintTimeline1 *) self;
...
void spine_constraint_timeline1_apply(spine_constraint_timeline1 self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    ConstraintTimeline1 *_self = (ConstraintTimeline1 *) self;
