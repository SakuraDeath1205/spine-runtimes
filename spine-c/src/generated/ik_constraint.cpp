...
void spine_ik_constraint_apply_1(spine_skeleton skeleton, spine_bone_pose bone, float targetX, float targetY, bool compress, bool stretch, spine_scale_y_mode scaleYMode, float mix) {
    IkConstraint::apply(*((Skeleton*)skeleton), *((BonePose*)bone), targetX, targetY, compress, stretch, (ScaleYMode)scaleYMode, mix);
}

void spine_ik_constraint_apply_2(spine_skeleton skeleton, spine_bone_pose parent, spine_bone_pose child, float targetX, float targetY, int bendDirection, bool stretch, spine_scale_y_mode scaleYMode, float softness, float mix) {
    IkConstraint::apply(*((Skeleton*)skeleton), *((BonePose*)parent), *((BonePose*)child), targetX, targetY, bendDirection, stretch, (ScaleYMode)scaleYMode, softness, mix);
}
