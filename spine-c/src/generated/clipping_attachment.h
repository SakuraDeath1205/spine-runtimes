 ...
 */
SPINE_C_API void spine_clipping_attachment_compute_world_vertices_1(spine_clipping_attachment self, spine_skeleton skeleton, spine_slot slot, size_t start, size_t count, /*@null*/ float * worldVertices, size_t offset, size_t stride);
 ...
 */
SPINE_C_API bool spine_clipping_attachment_is_timeline_active(spine_clipping_attachment self, spine_array_slot slots, int slotIndex, bool appliedPose);
