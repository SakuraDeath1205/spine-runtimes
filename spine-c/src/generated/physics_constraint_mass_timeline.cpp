...
spine_physics_constraint_mass_timeline spine_physics_constraint_mass_timeline_create(size_t frameCount, size_t bezierCount, int physicsConstraintIndex) {
    return (spine_physics_constraint_mass_timeline) new (__FILE__, __LINE__) PhysicsConstraintMassTimeline(frameCount, bezierCount, physicsConstraintIndex);
}
...
void spine_physics_constraint_mass_timeline_apply(spine_physics_constraint_mass_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
...
float spine_physics_constraint_mass_timeline_get_relative_value(spine_physics_constraint_mass_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
	return _self->getRelativeValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_physics_constraint_mass_timeline_get_absolute_value_1(spine_physics_constraint_mass_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup);
}

float spine_physics_constraint_mass_timeline_get_absolute_value_2(spine_physics_constraint_mass_timeline self, float time, float alpha, spine_mix_from from, bool add, float current, float setup, float value) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
	return _self->getAbsoluteValue(time, alpha, (MixFrom)from, add, current, setup, value);
}

float spine_physics_constraint_mass_timeline_get_scale_value(spine_physics_constraint_mass_timeline self, float time, float alpha, spine_mix_from from, bool add, bool out, float current, float setup) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
...
void spine_physics_constraint_mass_timeline_set_bezier(spine_physics_constraint_mass_timeline self, size_t bezier, size_t frame, float value, float time1, float value1, float cx1, float cy1, float cx2, float cy2, float time2, float value2) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
	_self->setBezier(bezier, frame, value, time1, value1, cx1, cy1, cx2, cy2, time2, value2);
}

float spine_physics_constraint_mass_timeline_get_bezier_value(spine_physics_constraint_mass_timeline self, float time, size_t frame, size_t valueOffset, size_t i) {
    PhysicsConstraintMassTimeline *_self = (PhysicsConstraintMassTimeline *) self;
