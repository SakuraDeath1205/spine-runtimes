...
void spine_draw_order_folder_timeline_apply(spine_draw_order_folder_timeline self, spine_skeleton skeleton, float lastTime, float time, /*@null*/ spine_array_event events, float alpha, spine_mix_from from, bool add, bool out, bool appliedPose) {
    DrawOrderFolderTimeline *_self = (DrawOrderFolderTimeline *) self;
...
void spine_draw_order_folder_timeline_set_frame(spine_draw_order_folder_timeline self, size_t frame, float time, /*@null*/ spine_array_int drawOrder) {
    DrawOrderFolderTimeline *_self = (DrawOrderFolderTimeline *) self;
